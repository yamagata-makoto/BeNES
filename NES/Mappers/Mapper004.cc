...
void
Mapper004::hblank(unsigned scanline)
{
  irqSetMode = false;
...
void
Mapper004::write8000(unsigned char data)
{
  chrOffset = 0x0000;
  if (data & 0x80) {
    chrOffset = 0x1000;
...
void
Mapper004::write8001(unsigned char data)
{
  setbanks(command, data);
}

void
Mapper004::writeA000(unsigned char data)
{
  if (data & 0x40) {
...
void
Mapper004::writeC000(unsigned char data)
{
  irqLatch = data;
  if (irqSetMode) {
    irqCounter = irqLatch;
...
void
Mapper004::writeC001(unsigned char data)
{
  irqSetMode = true;
  irqCounter = data;
}
...
void
Mapper004::writeE000(unsigned char data)
{
  irqEnabled = false;
}

void
Mapper004::writeE001(unsigned char data)
{
  irqEnabled = true;
...
void
Mapper004::write(unsigned address, unsigned char data)
{
...
void
Mapper004::setbank_chr2k(unsigned addr, unsigned char data)
{
...
void
Mapper004::setbank_chr1k(unsigned addr, unsigned char data)
{
  unsigned vram_offset = 0;
  unsigned vrom_offset = 0;
  vram_offset = addr ^ chrOffset;
...
void
Mapper004::setbank_prgA(unsigned char data)
{
...
void
Mapper004::setbank_prgB(unsigned char data)
{
  unsigned prom_offset = 0;
...
void
Mapper004::setbanks(unsigned char cmd, unsigned char data)
{
  regs[cmd & 0x07] = data;
  switch (cmd & 0x07) {
    case 0:
      setbank_chr2k(0x0000, data);
      break;
    case 1:
      setbank_chr2k(0x0800, data);
      break;
    case 2:
      setbank_chr1k(0x1000, data);
      break;
    case 3:
      setbank_chr1k(0x1400, data);
      break;
    case 4:
      setbank_chr1k(0x1800, data);
      break;
    case 5:
      setbank_chr1k(0x1c00, data);
      break;
    case 6:
      setbank_prgA(data);
      break;
